...
const getGameDiffPatch = (id, subtractAmount) => {
  ...
  fs.exists(configPath, (exists) => {
    ...
    NhlStats.Game.getTodayGames().then((games) => {
      ...
      NhlStats.Game.get(gameToWatch.id).then((game) => {
        ...
        const teamToWatch = teamIsHome ? game.gameData.teams.home : game.gameData.teams.away;
        ...
        let period = game.liveData.linescore.currentPeriod;
        ...
        gameLiveFeed = setInterval(() => {
          getGameDiffPatch(gameToWatch.id, refreshRate).then((diffPatch) => {
...
module.exports = {
  ...
  getGameDiffPatch: getGameDiffPatch,
